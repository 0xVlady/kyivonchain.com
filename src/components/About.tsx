...
const About: React.FC = () => {
  ...
  return <section id="about" className="py-20 relative overflow-hidden mb-20">
      ...
      <div className="absolute top-16 right-12 opacity-10">
        <div className="w-4 h-4 bg-chestnut/20 transform rotate-12" style={{
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 max-w-4xl mx-auto">
            <div className="text-lg text-foreground leading-relaxed space-y-4">
              ...
              <p>
                We created this hub because the Ukrainian Web3 scene has always been rich in talent but lacked a central place to gather, collaborate, and grow together. Especially after years of remote work, war, and scattered events, we saw the need for a permanent, trusted HQ where real connection and serendipitous collaboration can happen every day.
              </p>
              <p>
                Our mission is to make KYIV.ONCHAIN the go-to physical Web 3 space. Founders. Developers. Researchers. Operators. Traders. Educators. All under one roof.
              </p>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-2 gap-4 sm:hidden">
              {features.map((feature, index) => <div key={index} className="group h-full">
