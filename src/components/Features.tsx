        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {features.map((feature, index) => (
            <div key={index} className="flex flex-col items-center text-center p-2 sm:p-4 rounded-xl hover:scale-110 transition-all duration-300 group">
              ...
              <div className="w-16 h-16 sm:w-28 sm:h-28 md:w-32 md:h-32 mb-2 rounded-xl bg-primary/10 flex items-center justify-center shadow-lg group-hover:shadow-xl group-hover:bg-primary/20 transition-all duration-300">
                <feature.icon className="w-6 h-6 sm:w-12 sm:h-12 md:w-16 md:h-16 text-primary" />
              </div>
