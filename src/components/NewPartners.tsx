...
const NewPartners: React.FC = () => {
  ...
  // Partners data - 9 partners with local logo files
  const partners = [{
    name: "Acropolis",
    ...
    logo: "/logos/solana-temple-logo.png",
    category: "Technology",
    website: "#",
    ...
    logo: "/logos/venture-launch-logo.png",
