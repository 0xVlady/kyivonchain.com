...
const translations: Translations = {
  ...
  'nav.joinWaitlist': { en: 'Join Waitlist', uk: 'Хочу в лист очікування' },
  ...
  'hero.joinBtn': { en: 'Join Waiting List', uk: 'Хочу в лист очікування' },
  'hero.hostBtn': { en: 'Host Your Event', uk: 'Організувати свій івент' },
  'hero.hostBtnSoon': { en: 'Soon', uk: 'Скоро' },
  'hero.joinWaitlist': { en: 'Join Waitlist', uk: 'Хочу в лист очікування' },
