...
const translations: Translations = {
  ...
  'vision.solanaTitle': { en: 'Solana & Kumeka Team — Building with Purpose: A Foundation-Layer Partnership', uk: 'Solana & Kumeka Team — фундаментальні партнери з правильною мотивацією' },
  'vision.solana.desc1': { en: 'We didn\'t choose Solana and Kumeka Team by chance — we chose them because they build from first principles, at both the protocol and ecosystem level. That\'s exactly how we see KYIV.ONCHAIN: not as another co-working space, but as core infrastructure for Ukraine\'s Web3 future.', uk: 'Ми обрали Solana і Kumeka Team не випадково — це гравці, які мислять з перших принципів: на рівні протоколу та екосистеми. Саме так ми бачимо й KYIV.ONCHAIN — не як черговий коворкінг, а як інфраструктурну основу для Web3 в Україні.' },
  ...
  'vision.kumeka.title': { en: 'KUMEKA Team — Ukrainian Solana Hub', uk: 'Kumeka Team — український осередок Solana' },
  'vision.kumeka.desc1': { en: 'Kumeka Team helps the most promising projects in the Solana ecosystem launch and grow. Organized as a collective of creatives, developers, and operators, they bring deep experience in building and scaling tech businesses.', uk: 'Kumeka Team — це команда, яка допомагає найперспективнішим проєктам в екосистемі Solana запускатись і зростати.\nЦе колектив креаторів, девелоперів і операторів із реальним досвідом побудови технологічного бізнесу.' },
  'vision.kumeka.learnMore': { en: 'Learn more: [KUMEKA_LINK]', uk: 'Дізнатися більше: [KUMEKA_LINK]' },
  'vision.kumeka.desc2': { en: 'Kumeka Team values the sovereignty that comes with founding a company, the skin in the game that comes with investing, and the joy that comes with getting sh*t done. In a pre-crypto world, you had to choose: founder, investor, or employee. Crypto allows us to be all three — and Kumeka Team embodies that freedom.', uk: 'Вони вірять у свободу підприємництва, цінують особисту відповідальність в інвестуванні й кайф від реального прогресу. Раніше світ змушував обирати: фаундер, інвестор чи співробітник. Крипта дозволяє бути всім одразу. Kumeka Team живе цим принципом.' },
  'vision.kumeka.desc3': { en: 'As the core tenant of KYIV.ONCHAIN, Kumeka Team has supported this hub from day one.', uk: 'І саме вони стали основним партнером KYIV.ONCHAIN з першого дня запуску.' },
