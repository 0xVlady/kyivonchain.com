...
const translations: Translations = {
  ...
  'vision.missionSubtitle': { en: 'To build a permanent home for Web3 innovation in Ukraine — one that endures, adapts, and thrives, even when the world around it shakes.', uk: 'Створити постійний дім для Web3-інновацій в Україні — дім, що витримає, адаптується й процвітатиме, навіть коли світ навколо хитається.' },
  'vision.futureTitle': { en: 'The Future of Ukrainian Web3', uk: 'Майбутнє українського Web3' },
  'vision.future.desc1': { en: 'KYIV.ONCHAIN represents more than just a physical workspace—it\'s the cornerstone of Ukraine\'s digital sovereignty in the Web3 era. Our vision extends beyond borders, creating a global network where Ukrainian innovation leads the way in decentralized technologies.', uk: 'KYIV.ONCHAIN — це більше, ніж фізичний простір. Це фундамент цифрового суверенітету України в епоху Web3.\n\nНаше бачення виходить за межі кордонів — ми створюємо глобальну мережу, в якій українські інновації ведуть за собою розвиток децентралізованих технологій.' },
  'vision.future.desc2': { en: 'We envision a future where Ukraine becomes the premier destination for Web3 builders, researchers, and entrepreneurs from around the world, drawn by our unique combination of technical excellence, resilient infrastructure, and unwavering community spirit.', uk: 'Ми бачимо майбутнє, де Україна стає точкою тяжіння для Web3-білдерів, дослідників і підприємців з усього світу — завдяки унікальному поєднанню технічної глибини, стійкої інфраструктури та незламного ком\'юніті-духу.' },
  'vision.future.desc3': { en: 'What we are building is not just local — it\'s borderless, and its heartbeat is Ukrainian.', uk: 'Те, що ми будуємо — не лише локальне. Воно безмежне. Але його серце — українське.' },
  ...
  'vision.accelerators.desc1': { en: 'Solana doesn\'t just fund projects — it incubates them. The ecosystem includes top-tier accelerators.', uk: 'Solana не лише фінансує проєкти — вона їх виношує. Екосистема включає провідні акселераційні програми, зокрема:' },
  'vision.accelerators.desc2': { en: 'Each program provides hands-on mentorship, product support, and growth expertise tailored to Solana-native startups.', uk: 'Кожна з них — це менторство, продакт-сапорт і реальна експертиза, заточена під Solana-нативні стартапи.' },
  
  'vision.nodes.title': { en: '🌐 XYZ.ONCHAIN Local Nodes of a Global Movement', uk: '🌐 XYZ.ONCHAIN — локальні вузли глобального руху' },
  'vision.nodes.desc1': { en: 'Solana Superteams like UK, UAE, Kumeka, and others have proven how impactful local builder communities can be when given the right structure and support. They have helped to launch hundreds of projects.', uk: 'Superteam-ком\'юніті на кшталт UK, UAE, Kumeka та інших показали, яку силу мають локальні білдерські центри за правильної структури та підтримки. Вони вже допомогли сотням проєктів завдяки:' },
  'vision.nodes.desc2': { en: 'With Ukraine\'s growing Web3 scene, [XYZ].ONCHAIN aims to become the chain of IRL hubs in multiple cities activating and uniting regional talent into the broader Solana & Other Web3 ecosystem movements.', uk: 'З огляду на динамічний розвиток української Web3-сцени, [XYZ].ONCHAIN прагне створити мережу IRL-хабів у кількох містах, яка активує регіональні таланти та інтегрує їх у глобальні Web3-рухи.' },
  ...
  'events.solanaPong.desc': { en: 'In collaboration with Cudis, we hosted a community ping pong tournament at Network School.', uk: 'У співпраці з Cudis ми провели турнір з пінг-понгу серед спільноти на Network School.' },
  'events.vcConnect.title': { en: 'VC <> Startup Connect', uk: 'VC <> Startup Connect' },
  'events.vcConnect.desc': { en: 'Exclusive B2B gathering of VCs, founders, and ecosystem builders fostering investment opportunities and partnerships.', uk: 'Ексклюзивне B2B зібрання ВК, фаундерів та екосистемних білдерів для сприяння інвестиційним можливостям та партнерствам.' },
  'events.irlWorkshops.title': { en: 'IRL Workshops in Kyiv', uk: 'IRL Воркшопи у Києві' },
  'events.irlWorkshops.desc': { en: 'Workshop on GTM & Product Positioning.', uk: 'Воркшоп з GTM та позиціонування продукту.' },
  'events.hangouts.title': { en: 'Hangouts & Celebrations', uk: 'Hangouts і святкування' },
  'events.hangouts.desc': { en: 'Community gatherings and celebration events bringing together Web3 enthusiasts.', uk: 'Зібрання спільноти та святкові івенти, що об\'єднують Web3 ентузіастів.' },
