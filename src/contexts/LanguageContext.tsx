...
const translations: Translations = {
  ...
  'vision.solanaTitle': { en: 'Solana & Kumeka — Building with Purpose: A Foundation-Layer Partnership', uk: 'Solana & Kumeka Team — фундаментальні партнери з правильною мотивацією' },
