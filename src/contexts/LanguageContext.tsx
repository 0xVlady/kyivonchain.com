...
const translations: Translations = {
  ...
  'vision.kumeka.desc3': { en: 'As the core tenant of KYIV.ONCHAIN, Kumeka has supported this hub from day one.', uk: '' },
