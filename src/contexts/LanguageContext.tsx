...
const translations: Translations = {
  ...
  'membership.tier.guest.features.3': { en: 'Networking opportunities', uk: 'Базові можливості нетворкінгу' },
  ...
  'membership.tier.member.features.3': { en: 'Loyalty program rewards', uk: 'Унікальна програма лояльності' },
  'membership.tier.member.features.4': { en: 'Members only event invites', uk: 'Ексклюзивні заходи тільки для мемберів' },
  ...
  'membership.tier.member.features.7': { en: 'Exclusive investor network access', uk: 'Доступ до нетворку інвесторів' },
  ...
  'membership.tier.inner.features.5': { en: 'Exclusive alpha & deal flow', uk: 'Інсайди та доступ до топових угод' },
