...
const translations: Translations = {
  ...
  'vision.solana.grants': { en: 'The Solana ecosystem also offers a wide range of grants to support builders at every stage — from shipping early ideas to scaling public goods. Whether you\'re working on dev tooling, consumer apps, or community projects, there\'s funding available. Explore opportunities through the Solana Foundation Grants program and the Superteam Instagrants.', uk: 'Екосистема Solana також пропонує широкий спектр грантів для підтримки білдерів на кожному етапі — від реалізації ранніх ідей до масштабування публічних благ. Незалежно від того, працюєте ви над інструментами розробки, споживчими додатками чи комьюніті проєктами — є доступне фінансування. Досліджуйте можливості через програму Solana Foundation Grants і Superteam Instagrants.' },
  ...
  'vision.kumeka.learnMore': { en: 'Learn more: https://kumeka.team/', uk: 'Дізнатися більше: https://kumeka.team/' },
  ...
  'vision.accelerators.list': { en: 'Colosseum, Solana Incubator, Venture Launch, Outlier Ventures Base Camps', uk: 'Colosseum, Solana Incubator, Venture Launch, Outlier Ventures Base Camps' },
  ...
  'vision.nodes.desc2': { en: 'With Ukraine\'s growing Web3 scene, [XYZ].ONCHAIN aims to become the chain of IRL hubs in multiple cities activating and uniting regional talent into the broader Solana & Other Web3 ecosystem movements.', uk: 'З огляду на зростаючу Web3-сцену України, [XYZ].ONCHAIN прагне стати мережею IRL-хабів у кількох містах, що активує та об\'єднує регіональні таланти в ширші рухи екосистем Solana та інших Web3-платформ.' },
