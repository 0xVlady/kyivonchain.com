...
const translations: Translations = {
  ...
  'vision.kumeka.desc1': { en: 'Kumeka helps the most promising projects in the Solana ecosystem launch and grow. Organized as a collective of creatives, developers, and operators, they bring deep experience in building and scaling tech businesses. Learn more: [KUMEKA_LINK]', uk: 'Вони допомагають найперспективнішим проєктам в екосистемі Solana, запускатися та розвиватися. Вони організувались як колектив креативних людей та розробників, які мають досвід необхідний для запуску технологічного бізнесу. Вони цінують незалежність, яка приходить із заснуванням компанії, кайф який приходить з інвестуванням, і радість, яка приходить від того, що вони роблять свою справу. У світі до криптовалют їм доводилося підлаштовуватися під певну категорію - засновник, інвестор або працівник. Крипта дозволяє їм бути вільними та поєднувати всі 3 категорії. Ця ніша є відносно новою, незавершеною і призначеною для їхньої спільноти. Вони вивертають організацію навиворіт, щоб ви могли залетіти, знайти можливості та приєднатися до них у цій пригоді. Дізнатися більше: [KUMEKA_LINK]' },
  'vision.kumeka.learnMore': { en: 'Learn more: [KUMEKA_LINK]', uk: 'Дізнатися більше: [KUMEKA_LINK]' },
  'vision.kumeka.desc2': { en: 'Kumeka values the sovereignty that comes with founding a company, the skin in the game that comes with investing, and the joy that comes with getting sh*t done. In a pre-crypto world, you had to choose: founder, investor, or employee. Crypto allows us to be all three — and Kumeka embodies that freedom. As the core tenant of KYIV.ONCHAIN, Kumeka has supported this hub from day one. Learn more https://kumeka.team/', uk: 'Вони допомагають найперспективнішим проєктам в екосистемі Solana, запускатися та розвиватися. Вони організувались як колектив креативних людей та розробників, які мають досвід необхідний для запуску технологічного бізнесу. Вони цінують незалежність, яка приходить із заснуванням компанії, кайф який приходить з інвестуванням, і радість, яка приходить від того, що вони роблять свою справу. Вони вивертають організацію навиворіт, щоб ви могли залетіти та знайти можливості. І саме вони стали основним партнером KYIV.ONCHAIN з першого дня запуску. Дізнатися більше https://kumeka.team/' },
